...
@section('content')
<form action="{{url('pvone_six/'.$aviss->idss)}}" method="post">
    @csrf
<div class="content" style="margin-left:20%; margin-top: -2.5vh">
    <div class="sid">
        <div class="row g-3 align-items-center" style="margin-bottom: 0.5%;margin-left:2.5%;margin-top: 1.5%;">
            <div class="col-auto">
        ...
        <div class="avis-info" style="margin-bottom: 0%">
         ...
         <div class="avis-card" style="margin-top: 0% ;margin-bottom: 0%">
            <div class="row" id="glob" style="margin-bottom: 3% ; margin-top: 3%">
                Ajouter les montants des actes d'engagement
            </div>
        <div class="row" id="infor"  style="margin-top: 0% ; margin-bottom: 0% ;">
            <div class="container">
                <div id="tap" class="montant">

                    <div class="row hed">
                        <div class="col">1</div>
                        <div class="col">Nom </div>
                        <div class="col">Les actes d'engagements</div>
                    </div>
                    <div class="cl">
                        @for ($i = 0; $i < count($noms); $i++)
                        <div class="row">
                            <div class="col">{{$i+1}}</div>
                            <div class="col">{{$noms[$i]->Nom}}<input type="hidden" name='nomss[]' value="{{$noms[$i]->Nom}}"></div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Montant" name="montant{{$i}}">  DH
                            </div>
                        </div>
                        @endfor
                    </div>
