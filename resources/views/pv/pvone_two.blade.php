...
<div class="content" style="margin-left:20%; margin-top: -2.5vh">
    ...
    <form action="{{url('pvone_three/'.$aviss->idss)}}" method="post">
        @csrf
         <div class="avis-card" style="margin-top: 0% ;margin-bottom: 0%">
            ...
            <div class="row" id="infor"  style="margin-top: 0% ; margin-bottom: 0% ;">
                <div id="concurent">
                 <label >Entrer le numero des concurrents</label>
                 <input type="number" class="form-control" placeholder="" name="concurrent">
                 <label style='color:red;'> @error('concurrent'){{ $message}}@enderror</label>
                </div>
